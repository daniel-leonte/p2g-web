 ...
 * provides better readability during extended prompt engineering sessions.
 */
const config: Config = {
  darkMode: ["class"],
  content: [
  ...
  theme: {
    extend: {
      colors: {
        // Core theme colors using OKLCH color space for better color accuracy
        ...
        ring: 'oklch(var(--ring))',
        // Chart colors for prompt analytics and visualization
        chart: {
          '1': 'oklch(var(--chart-1))',
          '2': 'oklch(var(--chart-2))',
          '3': 'oklch(var(--chart-3))',
